...
void TrafficSimulator::OnHorloge()
{
  if (!m_Simulation)
    m_Simulation = Simulation::instance();
...
void TrafficSimulator::OnOuvertureSimulation()
{
...
void TrafficSimulator::OnLectureArretSimulation()
{
  if (!m_Simulation)
    m_Simulation = Simulation::instance();
...
void TrafficSimulator::OnReglageVitesseSim(int vitesse)
{
  if (!m_Simulation)
    m_Simulation = Simulation::instance();
...
void TrafficSimulator::OnAfficherVelocite(bool valeur)
{
...
void TrafficSimulator::OnAfficherForceMoteur(bool valeur)
{
...
void TrafficSimulator::OnAfficherFrottements(bool valeur)
{
