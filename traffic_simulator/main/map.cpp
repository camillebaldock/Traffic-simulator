...
/**
  ...
  */
Map::Road::Road(const QString& nomRoute, Map::Intersection* premiere, Map::Intersection* deuxieme)
...
const QString& Map::Road::nom() const {
    return m_Nom;
}

qreal Map::Road::longueur() const {
    return (m_Premier - m_Deuxieme).norme();
}

const Utils::Point& Map::Road::premier() const {
    return m_Premier;
}

Utils::Point& Map::Road::premier() {
    return m_Premier;
}

const Utils::Point& Map::Road::deuxieme() const {
    return m_Deuxieme;
}

Utils::Point& Map::Road::deuxieme() {
    return m_Deuxieme;
}

const Map::Intersection *Map::Road::getPremiereIntersection() const {
    return m_PremiereIntersection;
}

Map::Intersection *Map::Road::getPremiereIntersection() {
    return m_PremiereIntersection;
}

const Map::Intersection *Map::Road::getDeuxiemeIntersection() const {
    return m_DeuxiemeIntersection;
}

Map::Intersection *Map::Road::getDeuxiemeIntersection() {
    return m_DeuxiemeIntersection;
}

unsigned int Map::Road::largeur() const {
    return (m_VoiesPremVersDeux.count() + m_VoiesDeuxVersPrem.count())*LARGEUR_VOIE;
}

unsigned int Map::Road::nbVoies(Map::Road::Voie::Direction d) const {
    return d == Voie::PREM_VERS_DEUX ? m_VoiesPremVersDeux.count() : m_VoiesDeuxVersPrem.count();
}

unsigned int Map::Road::nbVoies() const {
...
/**
  ...
  */
const Map::Road::Voie& Map::Road::voie(Map::Road::Voie::Direction d, int positionVoie, bool& resultatOk) const {
...
void Map::Road::ajouterVoie(int positionVoie, Map::Road::Voie::Direction dir) {
...
void Map::Road::ajouterVoie(const Map::Road::Voie& v) {
...
void Map::Road::recalculerSegmentsVoie() {
...
Map::Road::Voie::Direction Map::Road::getDirection(const Intersection *prochaineIntersection) const {
...
Map::Intersection::Intersection(const QString& nom, const Utils::Point& emplacement)
: m_Nom(nom), m_Position(emplacement) {
}

const Utils::Point& Map::Intersection::emplacement() const {
    return m_Position;
}

const QString& Map::Intersection::nom() const {
    return m_Nom;
}

void Map::Intersection::ajouterVoisine(Map::Intersection* voisine) {
...
const Map::Intersection* Map::getIntersection(const Utils::Point& point) const {
...
const Map::Intersection* Map::getIntersection(const Map::Intersection *previousIntersection,
        const Map::Road *routeActuelle) const {
...
Map::Intersection* Map::getIntersection(const Utils::Point& point) {
    Intersection *inter = NULL;
...
const Map::Intersection* Map::getIntersection(const QString& nom) const {
    if (m_Intersections.contains(nom)) return m_Intersections[nom];
    else return NULL;
}

Map::ListeIntersections Map::getIntersections() const {
...
const Map::Road* Map::getRoute(const QString &nomRoute) const {
...
const Map::Road* Map::getRoute(
        const Map::Intersection* intersection1,
        const Map::Intersection* intersection2) const {
...
/**
  ...
  */
Map::ListeRoutes Map::getRoutes(const Map::Intersection *intersection) const {
    ListeRoutes routes;
    if (intersection) {
        foreach(Road* r, m_Routes) {
...
/**
  ...
  */
Map::ListeRoutes Map::getRoutes() const {
    return m_Routes;
}

void Map::creerTrousIntersection() {
    ...
    foreach(Intersection *i, m_Intersections) {
        ...
        for (compteurRouteExt = routes.begin(); compteurRouteExt != routes.end(); ++compteurRouteExt) {
            ...
            for (compteurRouteInt = routes.begin(); compteurRouteInt != routes.end(); ++compteurRouteInt) {
                Road *routeExterieure = *compteurRouteExt, *routeInterieure = *compteurRouteInt;
